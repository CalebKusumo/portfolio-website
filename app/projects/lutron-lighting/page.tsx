      ...
      <div className="relative z-10 w-full">
        ...
        <section className="relative h-screen w-full flex flex-col items-center justify-center text-center bg-black overflow-hidden shadow-2xl">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="relative z-10 px-4">
            <span className="font-mono text-[10px] tracking-[0.6em] text-blue-600 mb-4 uppercase block">Architectural: 2025</span>
            <h1 className="text-6xl md:text-[10rem] font-black tracking-tighter uppercase leading-[0.8] mix-blend-difference">LUTRON <br /> <span className="text-outline italic text-white text-7xl md:text-[8rem]">LIGHTING</span></h1>
          </motion.div>
        </section>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="aspect-video bg-white/5 overflow-hidden border border-white/10 group">
               <img src="/projects/lutron-lighting/detail-1.jpg" className="w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-700" alt="Photometrics" />
            </div>
            <div className="border-l-2 border-blue-600 pl-8">
              ...
              <p className="text-gray-500 font-mono text-[10px] tracking-widest uppercase">AGI32 Simulation // 98 CRI // R9 Optimization</p>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 border-r-2 border-white/20 pr-8 text-right">
              ...
              <p className="text-gray-500 font-mono text-[10px] tracking-widest uppercase">Athena Hub // Daylight Harvesting</p>
            </div>
            <div className="order-1 md:order-2 aspect-video bg-white/5 overflow-hidden border border-white/10 group">
               <img src="/projects/lutron-lighting/detail-2.jpg" className="w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-700" alt="Controls" />
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="aspect-video bg-white/5 overflow-hidden border border-white/10 group">
               <img src="/projects/lutron-lighting/detail-3.jpg" className="w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-700" alt="Energy Model" />
            </div>
            <div className="border-l-2 border-white/20 pl-8">
              <h3 className="text-3xl font-black uppercase italic text-white mb-2">Energy Model</h3>
              <p className="text-gray-500 font-mono text-[10px] tracking-widest uppercase">LPD: 0.45 W/SQFT // IECC 2021 Compliant</p>
            </div>
          </motion.div>
        </motion.div>
