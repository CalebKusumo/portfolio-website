...
export default function LutronProject() {
  ...
  return (
    <main ref={containerRef} className="relative bg-black min-h-screen">
      ...
      {/* This stays behind everything and rotates as you scroll */}
      ...
      <div className="relative z-10 w-full">
        ...
        {/* HEADER SECTION: This acts as the "Cover" */}
        <section className="relative h-screen w-full flex flex-col items-center justify-center text-center bg-black overflow-hidden shadow-2xl">
          <div className="absolute inset-0 z-0">
            ...
            />
            {/* Dark gradient to blend the bottom of the photo into the model reveal */}
        ...
        {/* SPACER: This creates the "empty" space where only the model is visible */}
