      ...
      <div className="relative z-10 w-full">
        <section className="relative h-screen w-full flex flex-col items-center justify-center text-center bg-black overflow-hidden shadow-2xl">
          <div className="absolute inset-0 z-0">
            <img src="/projects/mamiya-hood/header.jpg" className="w-full h-full object-cover opacity-40 grayscale" alt="Mamiya Hood" />
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="relative z-10 px-4">
            <span className="font-mono text-[10px] tracking-[0.6em] text-purple-500 mb-4 uppercase block text-center">Industrial Design: C330 System</span>
            <h1 className="text-6xl md:text-[10rem] font-black tracking-tighter uppercase leading-[0.8] mix-blend-difference text-center">LENS <br /> <span className="text-outline italic text-white text-7xl md:text-[8rem]">HOOD</span></h1>
          </motion.div>
        </section>
