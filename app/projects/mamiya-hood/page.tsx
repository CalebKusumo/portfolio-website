...
const details = [
  ...
  },
  {
    ...
    alt: 'Stray Light',
    title: 'Stray Light',
    body: 'Flare Reduction Geometry // Optimized for Mamiya 135 4.5',
  ...
  },
  {
    ...
    alt: 'Additive Mfg',
    title: 'Additive Mfg',
    body: '3D Printed PETG // Matte Black Internal Flocking // Impact Resistant',
    accent: 'border-purple-500',
  },
];
    ...
    <main className="relative bg-black min-h-screen">
      ...
      <div className="relative z-10 w-full">
        ...
        <section className="relative aspect-[3/2] w-full flex flex-col items-center justify-center text-center bg-black overflow-hidden shadow-2xl">
          ...
          >
            <span className="font-mono text-[10px] tracking-[0.6em] text-purple-500 mb-4 uppercase block text-center">
              Industrial Design: C330 System
            </span>
            <h1 className="text-6xl md:text-[10rem] font-black tracking-tighter uppercase leading-[0.8] mix-blend-difference text-center">
              LENS <br />
              <span className="text-outline italic text-white text-7xl md:text-[8rem]">HOOD</span>
            </h1>
          </motion.div>
        </section>
        ...
        <footer className="py-24 flex flex-col items-center justify-center bg-black relative z-20 pointer-events-auto border-t border-white/10 gap-10">
          <div className="text-center">
            <p className="font-mono text-[10px] tracking-[1em] text-purple-500 uppercase mb-4 text-center">End of Documentation</p>
