...
const details = [
  {
    ...
    alt: 'First Photo Ever Taken',
    title: 'First Photo Ever Taken',
    body: 'Paper Negative // Ilford Multigrade',
  ...
  },
  {
    ...
    body: 'Solidworks Geometry Study // Optimized for Easy Manufacturing, Assembly, and Shooting // Monorail Architecture',
  ...
  },
  {
    ...
    alt: 'Bellows',
    title: 'Bellows',
    body: 'Nylon Rip-Stop Fiber Composite Ribs // Polyester Light Seal',
    accent: 'border-emerald-500',
  },
  {
    ...
    alt: 'Ground Glass',
    title: 'Ground Glass',
    body: 'Laser-Cut Matte Screen // Alignment Grid Lines Engraved // Hand Ground for Focus',
    accent: 'border-white/20',
  },
  {
  ...
  },
  {
    ...
    alt: 'Bellows Clamp',
    title: 'Bellows Clamp',
    body: 'Dual-Purpose Hardware // Clamping and Assembly in One // Reduced Part Count and Assembly Time',
    accent: 'border-white/20',
  },
  {
