    ...
    <main className="relative bg-black">
      ...
      <div className="relative z-10 w-full overflow-hidden">
        ...
        <section className="h-screen flex items-center justify-end px-8 md:px-32">
          <Link href="/experience" className="group max-w-md border-r-2 border-white/20 pr-10 text-right hover:border-blue-600 transition-all">
        ...
        {/* FOOTER - Anchored safely at the bottom */}
