...
const ModelViewer = dynamic(() => import('@/components/ModelViewer'), { 
  ssr: false,
  loading: () => <div className="fixed inset-0 bg-black flex items-center justify-center font-mono text-white text-[10px] tracking-[0.5em]">INITIALIZING_CORE...</div>
});

export default function Home() {
  return (
    <main className="relative bg-black min-h-[600vh]">
      ...
      <div className="relative z-10 w-full overflow-hidden">
        ...
        <section className="h-screen flex items-center justify-start px-8 md:px-32">
          <Link href="/projects" className="group max-w-md border-l-2 border-white/20 pl-10 hover:border-blue-600 transition-all">
        ...
        <section className="h-screen flex items-center justify-end px-8 md:px-32">
          <Link href="/contact" className="group max-w-md border-r-2 border-blue-600 pr-10 text-right hover:border-white transition-all">
            ...
            <p className="text-gray-400 font-mono text-[10px] tracking-[0.3em] uppercase underline underline-offset-8">Signal Established</p>
          </Link>
        </section>
